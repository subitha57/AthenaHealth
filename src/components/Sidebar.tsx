...
export default function ResponsiveDrawer(props: Props) {
 ...
 const navigate = useNavigate();
  ...
  const HandlerPatientDetails=()=>{
    navigate('/PatientInformation')
  }
  const HandlePatientInfoHandouts=()=>{
    navigate('/PatientInfoHandouts')
  }
  ...
  const drawer = (
    <div>
      ...
      <Divider />
      <List className='list'>
       <Button onClick={HandlePatientInfoHandouts}>PatientInfoHandouts</Button>
       <Button onClick={HandlerPatientList}>Patient List</Button>
       <Button onClick={HandlerOptionalList}>PatientList-Optional</Button>
       <Button onClick={HandlerPatientSearch}>SearchType</Button><br/>
       <Button onClick={HandlerPatientDetails}>PatientDetails</Button>
